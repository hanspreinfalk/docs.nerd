      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 lg:px-2">
        ...
        >
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Comenzando</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Tutorial paso a paso para crear tu primer proyecto</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 h-[180px] flex flex-col">
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Integraciones</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Extiende la funcionalidad con integraciones</p>
          </div>
        </div>
        ...
        >
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Consejos y Trucos</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Aprovecha al máximo Nerd</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Prompting</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Aprende estrategias efectivas de prompting</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 h-[180px] flex flex-col relative">
          ...
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Casos de Uso</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Ver tutoriales en video y lo que otros han construido</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 h-[180px] flex flex-col relative">
          ...
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Glosario</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Aprende los términos clave</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-700 h-[180px] flex flex-col relative">
          ...
          <div className="space-y-3 flex flex-col h-full">
            ...
            <h1 className="text-lg font-semibold text-black dark:text-white flex-shrink-0">Plantillas</h1>
            <p className="text-sm text-black dark:text-gray-300 flex-grow">Explora y usa plantillas de proyectos</p>
          </div>
        </div>
