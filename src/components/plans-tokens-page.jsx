        ...
        <div className="w-full max-w-3xl mt-6 px-4 lg:px-6 space-y-8">
          ...
          <div id="comparacion-planes" className="space-y-4">
            ...
            <div className="space-y-6">
              ...
              {/* Plan Business */}
              <div className="space-y-3">
                <h3 className="text-xl font-semibold">Plan Business</h3>
                <ul className="list-disc list-inside space-y-2 text-base text-black">
          ...
          <div id="uso-creditos" className="space-y-4">
            ...
            <h3 className="text-xl font-semibold">Ejemplos de prompts y su costo:</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-300 px-4 py-2 text-left">Prompt del Usuario</th>
                    <th className="border border-gray-300 px-4 py-2 text-left">Trabajo realizado</th>
                    <th className="border border-gray-300 px-4 py-2 text-left">Créditos usados</th>
                  </tr>
                </thead>
                <tbody>
                  <tr><td className="border border-gray-300 px-4 py-2">Haz el botón gris</td><td className="border border-gray-300 px-4 py-2">Cambia los estilos del botón</td><td className="border border-gray-300 px-4 py-2">0.50</td></tr>
                  <tr><td className="border border-gray-300 px-4 py-2">Remueve el footer</td><td className="border border-gray-300 px-4 py-2">Remueve el componente footer</td><td className="border border-gray-300 px-4 py-2">0.90</td></tr>
                  <tr><td className="border border-gray-300 px-4 py-2">Agrega autenticación</td><td className="border border-gray-300 px-4 py-2">Agrega lógica de login y autenticación</td><td className="border border-gray-300 px-4 py-2">1.20</td></tr>
                  <tr><td className="border border-gray-300 px-4 py-2">Construye una landing page con imágenes</td><td className="border border-gray-300 px-4 py-2">Crea una landing page con imágenes generadas, tema y secciones</td><td className="border border-gray-300 px-4 py-2">2.00</td></tr>
                </tbody>
              </table>
            </div>
          ...
          <div id="acumulacion-creditos" className="space-y-4">
            ...
            <h3 className="text-xl font-semibold">Límites de acumulación de créditos:</h3>
            <ul className="list-disc list-inside space-y-2 text-base text-black">
            ...
            <h3 className="text-xl font-semibold">Vencimiento de créditos acumulados:</h3>
            <ul className="list-disc list-inside space-y-2 text-base text-black">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-red-800 mb-2">Cancelación:</h3>
